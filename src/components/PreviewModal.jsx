export default function ItemModal({ isOpen, book, handleCloseModal }) {
  return (
    <div
      className={`modal invisible fixed inset-0 bg-black/50 flex flex-col justify-center items-center ${
        isOpen && '!visible'
      }`}
    >
      <div className="modal__container relative py-4 px-4 rounded-lg bg-gray-700 text-white shadow-[0_10px_30px_rgba(0,0,0,0.8)] box-border">
        <button
